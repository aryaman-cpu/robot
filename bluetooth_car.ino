...
// // ==========================================
// // NOTE: The Servo library uses Timer 1 on the Uno. Pins 9 and 10 are
// direction
// // pins only (digitalWrite), so there is NO conflict with our PWM enable pins
// 5
// // & 6.
...
//     // Weapon ('u','d'), stop ('s'), and speed ('+','-') commands do NOT
//     reset
//     // the timer. This is intentional: if the remote app crashes but gets
//     stuck
